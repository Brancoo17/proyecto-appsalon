...
<div class="busqueda busqueda-con-acciones">
    ...
    <div class="acciones-cabecera-admin">
        <button type="button" id="btn-bloquear-horario" class="boton-bloquear-horario" title="Bloquear un intervalo de mi horario">
            <i class="fa-solid fa-lock"></i> Bloquear Horario
        </button>
        <?php if(!empty($bloqueos)): ?>
            <span class="badge-resumen-bloqueos" title="Mis horarios bloqueados en esta fecha">
...
<?php
    ...
    // Construir la agenda combinada del día (turnos asignados + horarios bloqueados)
    $agendaDelDia = [];
...
<?php if(count($agendaDelDia) === 0): ?>
    <div class="alerta-vacio">
        <p><i class="fa-solid fa-calendar-xmark"></i> No tienes turnos ni horarios bloqueados para esta fecha</p>
    </div>
<?php else: ?>
                    ...
                    <?php if($item['tipo'] === 'bloqueo'): ?>
                        <tr class="fila-bloqueo">
                            ...
                            <td class="col-cliente">
                                ...
                                <span class="cliente-contacto"><?php echo s($item['peluquero']); ?></span>
                            </td>
